...
# Contraseña 
contrasena = "s46vy9nrcx"
contrasena2 = "ait7lvf2ni"
...
@app.route("/tienda_de_libros", methods=['GET', 'POST'])
def tienda_de_libros():
    if request.method == 'POST':
        ...
        return redirect(url_for('tienda_de_libros'))
    
    # Si es una solicitud GET, renderizar el formulario
    return render_template("tienda_de_libros.html", libros=libros)
...
def cargar_libro():
    if request.method == 'POST':
        ...
        # Manejar la solicitud GET renderizando una plantilla
        return render_template("cargar_libro.html")  # Reemplaza con el nombre correcto de tu plantilla
